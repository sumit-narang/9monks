...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"basic_linear",prev:"",next:"",duration:20*100,delay:24*100,outWidth:640,outHeight:360,width:640,height:360,autoPlay:true,stopOnHover:true,loop:false,bullets:true,caption:false,controls:false});